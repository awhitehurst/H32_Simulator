 ...
 * @author Whitehurst
 */
public interface RegisterManipulator {
    ...
    public static final int ITB = 18;
    public static final int INTE = 19;
    public static final int INTX = 20;
    ...
    public static final int R30 = 20;
    public static final int TMP = 31;
